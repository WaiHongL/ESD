        ...
        <div class="header-container__content">
            ...
            <div class="header-container__user-container">
                <!-- <span @click="displayCart(true)" class="material-symbols-outlined me-3 header-container__cart"
                    :class="{ 'text-primary': cart && cart.length >= 1 }">shopping_bag</span> -->
                ...
                <!-- <div v-if="isCartVisible" class="header-container__cart-items-container">
                    <div class="d-flex justify-content-between align-items-center">
                        ...
                        <span @click="displayCart(false)"
                            class="material-symbols-outlined header-container__close-btn">close</span>
                    </div>
                    ...
                    <button @click="handleCheckout()" class="btn btn-primary checkout-btn"
                        :class="{ disabled: cart && cart.length == 0 }">Checkout</button>
